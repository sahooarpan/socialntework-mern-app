...
router.post(
  ...
  async (req, res) => {
    ...
    console.log(profileFields.user, "pfuser");
    if (company) {
    ...
    console.log(profileFields.githubusername);
    ...
    if (fb) profileFields.social.facebook = fb;
...
// @route DELETE api/profie/experience/:exp_id
...
// @route GET api/profie/github/:username
// @desc Delete education from profile
// @access Private
